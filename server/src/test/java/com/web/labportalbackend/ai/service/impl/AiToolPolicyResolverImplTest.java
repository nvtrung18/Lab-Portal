...
class AiToolPolicyResolverImplTest {
    ...
    private static final List<ExpectedTool> EXPECTED_TOOLS = List.of(
            ...
            expected(AiToolId.LAB_SLOT_READ, AiCapability.LAB_SLOT_READ, AiAssistantKey.LAB_ASSISTANT,
                    ...
                    AiRequestedAction.READ, AiActionRiskBoundary.READ_ONLY, RESOURCE),
            expected(AiToolId.LAB_AVAILABLE_SLOTS_READ, AiCapability.LAB_AVAILABLE_SLOTS_READ,
                    AiAssistantKey.LAB_ASSISTANT, AiAssistantDomain.LAB, AiAssistantToolGroup.LAB_READ,
                    AiResourceType.LABORATORY, null, AiRequestedAction.READ,
                    AiActionRiskBoundary.READ_ONLY, RESOURCE),
            ...
            expected(AiToolId.LAB_MANAGED_SUMMARY, AiCapability.LAB_MANAGED_SUMMARY, AiAssistantKey.LAB_ASSISTANT,
                    AiAssistantDomain.LAB, AiAssistantToolGroup.LAB_READ, AiResourceType.LABORATORY, null,
                    AiRequestedAction.READ, AiActionRiskBoundary.READ_ONLY, RESOURCE),
            expected(AiToolId.LAB_SHIFT_CREATE_DRAFT, AiCapability.LAB_SHIFT_CREATE_DRAFT,
                    AiAssistantKey.LAB_ASSISTANT, AiAssistantDomain.LAB, AiAssistantToolGroup.LAB_DRAFT,
                    AiResourceType.LABORATORY, null, AiRequestedAction.DRAFT,
                    AiActionRiskBoundary.DRAFT_ONLY, RESOURCE),
