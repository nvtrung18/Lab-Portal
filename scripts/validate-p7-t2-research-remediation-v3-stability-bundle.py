#!/usr/bin/env python3
"""Validate the approved P7-T2 remediation v3 numerical-stability T4 bundle."""
...
BASE = _load_module("p7_t2_remediation_base_validator_for_v3_stability", BASE_VALIDATOR_PATH)
BUNDLE_NAME = "p7-t2-research-remediation-v3-stability-t4"
...
TRAINING_CONFIG_REFERENCE = "config/p7-t2-training-pipeline-t4-remediation-v3-stability.json"
TRAINING_PIPELINE_REFERENCE = "scripts/training-pipeline-p7-t2-remediation-v3.py"
BACKEND_REFERENCE = "scripts/p7-t2-real-training-remediation-v3.py"
REQUIRED_FILES = {
    "README.md",
    ...
    "config/p7-t4-research-remediation-governance-v3/stability-retry-approval-request.json",
    ...
    "docs/architecture/ai/p7-t4-research-remediation-v3-stability-runbook.txt",
    ...
    "evidence/p7-t2-real-training/remediation-v3-quarantine/p7-t2-research-remediation-v3-quarantined-nonfinite-gradient.zip.sha256",
    ...
    "scripts/validate-p7-t2-research-remediation-v3-stability-bundle.py",
}
...
for name, value in {
    ...
    "EXECUTION_APPROVAL_IDENTITY": EXECUTION_APPROVAL_IDENTITY,
