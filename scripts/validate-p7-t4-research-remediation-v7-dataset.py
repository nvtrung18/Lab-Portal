#!/usr/bin/env python3
"""Validate the governed retention-first Research remediation-v7 dataset."""
...
BUILDER = _load_module("p7_t4_remediation_v7_source_for_validator", BUILDER_PATH)
...
def validate_checked_in_dataset() -> dict[str, object]:
    ...
    if (
        {split: len(values) for split, values in records.items()} != BUILDER.RECORD_COUNTS
