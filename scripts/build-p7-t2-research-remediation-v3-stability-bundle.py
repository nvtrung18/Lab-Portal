#!/usr/bin/env python3
"""Build the approved P7-T2 remediation v3 numerical-stability T4 bundle."""
...
BASE = _load_module("p7_t2_remediation_base_builder_for_v3_stability", BASE_BUILDER_PATH)
...
VALIDATOR_REFERENCE = "scripts/validate-p7-t2-research-remediation-v3-stability-bundle.py"
SOURCE_FILES = (
