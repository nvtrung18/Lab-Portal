#!/usr/bin/env python3
"""Validate a P7-T2 Research remediation v3 T4 bundle and real output."""
...
BASE_VALIDATOR_PATH = Path(__file__).with_name(
    "validate-p7-t2-research-remediation-bundle.py"
)
...
BASE = _load_module("p7_t2_remediation_bundle_validator_v2_for_v3", BASE_VALIDATOR_PATH)
...
REQUIRED_FILES = {
    ...
    "scripts/validate-p7-t2-research-remediation-v3-bundle.py",
}
