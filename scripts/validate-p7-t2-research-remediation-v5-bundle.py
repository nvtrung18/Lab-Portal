#!/usr/bin/env python3
"""Validate a P7-T2 Research remediation v5 T4 bundle and real output."""
...
BASE = _load_module("p7_t2_remediation_bundle_validator_for_v5", BASE_VALIDATOR_PATH)
...
BACKEND_REFERENCE = "scripts/p7-t2-real-training-remediation-v5.py"
REQUIRED_FILES = {
    "README.md",
    ...
    "scripts/validate-p7-t2-research-remediation-v5-bundle.py",
}
