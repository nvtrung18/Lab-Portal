#!/usr/bin/env python3
"""Real single-T4 QLoRA backend for governed Research remediation v4."""
...
BASE = _load_module("p7_t2_remediation_backend_v2_for_v4", BASE_BACKEND_PATH)
RECORD_SCHEMA_VERSION = "4.0.0"
EXPECTED_TRAIN_RECORDS = 112
EXPECTED_VALIDATION_RECORDS = 16
EXPECTED_CONTRACT_HOLDOUT_RECORDS = 16
