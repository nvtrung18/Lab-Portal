#!/usr/bin/env python3
"""Real single-T4 QLoRA backend for governed Research remediation v5."""
...
BASE = _load_module("p7_t2_remediation_backend_for_v5", BASE_BACKEND_PATH)
RECORD_SCHEMA_VERSION = "5.0.0"
EXPECTED_TRAIN_RECORDS = 144
EXPECTED_VALIDATION_RECORDS = 24
EXPECTED_CONTRACT_HOLDOUT_RECORDS = 24
