#!/usr/bin/env python3
"""Build the deterministic P7-T2 Research remediation v8 T4 bundle."""
...
BASE = _load_module("p7_t2_remediation_bundle_builder_for_v8", BASE_BUILDER_PATH)
...
VALIDATOR_REFERENCE = "scripts/validate-p7-t2-research-remediation-v8-bundle.py"
SOURCE_FILES = (
    ...
    "scripts/p7-t2-real-training-remediation-v8.py",
