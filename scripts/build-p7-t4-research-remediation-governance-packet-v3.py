#!/usr/bin/env python3
"""Build the pending governance request for P7-T4 remediation source v3."""
...
SOURCE_DIRECTORY = ROOT / "datasets" / "p7-t4-research-remediation-source-v3"
...
CANONICAL_OUTPUT_DIRECTORY = ROOT / "config" / "p7-t4-research-remediation-governance-v3"
...
SOURCE_BASE_COMMIT = "23f920f4da5b4f7266d0991af3af34921994600b"
PRIOR_REMEDIATION_IDENTITY = "2bf3bd9bf61c78637c4f023eadf41503c53546d8a1a7274fadecd10b43e6b9cc"
...
SOURCE = _load_module("p7_t4_source_v3_for_governance", SOURCE_BUILDER_PATH)
...
def _sanitization() -> dict[str, Any]:
    transform = "scripts/build-p7-t4-research-remediation-source-v3.py"
    result = "datasets/p7-t4-research-remediation-source-v3/provenance.json#/antiLeakage"
    residual = "datasets/p7-t4-research-remediation-source-v3/provenance.json#/coverage"
    reviewer = "P7-T4-REMEDIATION-V3-AWAITING-GOVERNANCE-REVIEW"
    return {
...
def _card(source: dict[str, Any]) -> dict[str, Any]:
    ...
    source_reference = "datasets/p7-t4-research-remediation-source-v3/source-export.json"
    provenance_reference = "datasets/p7-t4-research-remediation-source-v3/provenance.json"
    contract_reference = "datasets/p7-t4-research-remediation-source-v3/training-contract.json"
    return {
        "dataset_id": DATASET_ID,
        "dataset_version": DATASET_VERSION,
        "contract_version": "1.0.0",
        "schema_version": "1.0.0",
        "title": "Pending bilingual public-contract Research remediation dataset",
        "description": "Independent synthetic UC003-UC005 contract variants for a new P7-T2 run; no approval, training authorization, or P7-T4 PASS is asserted.",
        ...
        "retention": {
            ...
            "trigger_reference": "P7-T4-REMEDIATION-V3-TRAINING-COMPLETION-OR-REQUEST-DISPOSITION",
            "evidence_reference": "P7-T4-REMEDIATION-V3-RETENTION-EVIDENCE-REQUIRED",
            "start_reference": "P7-T4-REMEDIATION-V3-RETENTION-START-REFERENCE-REQUIRED",
            "recheck_or_expiry_reference": "P7-T4-REMEDIATION-V3-POST-EXPERIMENT-RECHECK-REQUIRED",
        ...
        "lineage": {
            "source_references": [
                ...
                f"p7-t4-remediation-v3-content-sha256:{provenance['contentIdentity']}",
            ],
            "transform_references": ["scripts/build-p7-t4-research-remediation-source-v3.py"],
        },
        "integrity": {
            "checksum": source["sourceSha256"],
            "checksum_algorithm": "SHA-256",
            "verified_at_reference": "P7-T4-REMEDIATION-V3-DETERMINISTIC-SOURCE-VERIFICATION",
        },
        "split": {"label": "TRAIN"},
        ...
        "created_at_reference": "P7-T4-REMEDIATION-V3-NOT-RECORDED-DETERMINISTIC-REQUEST",
        "revocation_reference": "P7-T4-REMEDIATION-V3-REVOCATION-EVIDENCE-REQUIRED",
    }
...
def _request(source: dict[str, Any], card: dict[str, Any]) -> dict[str, Any]:
    ...
    provenance = source["provenance"]
    reevaluation = remediation["reevaluationResult"]
    request = {
        "artifactType": "P7-T1B-RESEARCH-REMEDIATION-TRAINING-GOVERNANCE-REQUEST",
        "schemaVersion": "1.0.0",
        "requestId": "P7-T1B-RESEARCH-REMEDIATION-TRAINING-GOVERNANCE-REQUEST-002",
        "status": "PENDING_USER_APPROVAL",
        "approvalAuthority": APPROVAL_AUTHORITY,
        "source": {
            "sourceId": SOURCE.SOURCE_ID,
            "sourceVersion": SOURCE.SOURCE_VERSION,
            "sourceReference": "datasets/p7-t4-research-remediation-source-v3/source-export.json",
            "sourceSha256": source["sourceSha256"],
            "contentIdentity": provenance["contentIdentity"],
            "provenanceReference": "datasets/p7-t4-research-remediation-source-v3/provenance.json",
            "provenanceIdentity": provenance["provenanceIdentity"],
            "contractReference": "datasets/p7-t4-research-remediation-source-v3/training-contract.json",
        ...
        "candidateCard": {
            ...
            "reference": "config/p7-t4-research-remediation-governance-v3/training-dataset-card.pending.json",
        ...
        "remediationBinding": {
            ...
            "failedCandidateId": reevaluation["candidateId"],
            "failedComparisonIdentity": reevaluation["comparisonIdentity"],
        ...
        "requestedScope": {
            ...
            "intendedDownstreamUse": [
                "P7-T1C_REMEDIATION_V3_DATASET_MATERIALIZATION",
        ...
        "requester": "P7_T4_REMEDIATION_V3_IMPLEMENTATION_AGENT",
        "approval": None,
        "approvedBy": None,
        "approvedAt": None,
        "requestIdentity": "",
