#!/usr/bin/env python3
"""Build the deterministic P7-T2 Research remediation v4 T4 bundle."""
...
BASE = _load_module("p7_t2_remediation_bundle_builder_v2_for_v4", BASE_BUILDER_PATH)
...
VALIDATOR_REFERENCE = "scripts/validate-p7-t2-research-remediation-v4-bundle.py"
SOURCE_FILES = (
    ...
    "scripts/p7-t2-real-training-remediation-v4.py",
