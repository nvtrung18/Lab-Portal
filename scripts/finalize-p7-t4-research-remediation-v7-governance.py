#!/usr/bin/env python3
"""Materialize the approved P7-T4 remediation-v7 dataset preparation scope."""
...
PREPARATION_PATH = ROOT / "scripts" / "build-p7-t4-research-remediation-v7-preparation.py"
REQUEST_IDENTITY = "4ecf97b220aca189ff807b8b86288f9458bf96fd421152c6ed1a9f4a839913ba"
REQUEST_REFERENCE = (
...
PREPARATION = _load_module(
    "p7_t4_remediation_v7_preparation_for_finalizer", PREPARATION_PATH
)
...
def build_documents() -> dict[str, dict[str, Any]]:
    ...
    analysis = pending["failure-analysis-v6.json"]
    quality = pending["training-data-quality-spec-v7.json"]
    ...
    if (
        ...
        or requested_scope.get("datasetV7PreparationRequested") is not True
        ...
        raise FinalizationError("exact approved remediation-v7 request required")
    ...
    approval: dict[str, Any] = {
        ...
        "artifactType": "P7-T4-RESEARCH-REMEDIATION-V7-GOVERNANCE-APPROVAL",
        "authorization": {
            "approvedV6RetentionReuseAllowed": True,
            "constrainedDecodingAllowed": False,
            "datasetV7PreparationAllowed": True,
